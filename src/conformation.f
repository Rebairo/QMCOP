...
c	program to write pdb file from cg output
	...
	character*30 atom,atx
        character*24 ele
	character atx1*12
	character*3 atx2,ares(maxpar)
	character atx3*10

15	format(a30,3f8.3,a24)
16	format(a12,a3,2x,a3,a10,3f8.3,a24)
...
313	do i=1,natom
	atx=atom(i)
        ares(i)=atx(18:20)
        IF(atx(13:16).ne.' HN ') THEN
        IF(atx(13:16).ne.' NH '.and.atx(13:16).ne.' HO ')THEN
        if(atx(13:16).eq.' O1 ')then
	atx1=atx(1:12)
        atx2='OXT'
        atx3=atx(21:30)
        write(50,16)atx1,atx2,ares(i-1),atx3,y(i,1),y(i,2),y(i,3),ele(i)
 	else        
